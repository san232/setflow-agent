...
곡의 분위기 고저차를 고려해 플레이리스트를 만드는 Python 에이전트 서버입니다. King Gnu 43곡의 조사 초깃값을 불러오고, 원하는 흐름을 선택하면 곡 순서와 배치 이유를 확인할 수 있습니다. YouTube에서 곡을 검색해 보관함에 영상 링크를 연결하거나 새 곡을 등록할 수 있습니다.
